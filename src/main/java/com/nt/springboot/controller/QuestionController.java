package com.nt.springboot.controller;
...
import com.nt.springboot.service.IQuestionService;
...
public class QuestionController {
	...
	public ResponseEntity<List<Question>> getQuestionsForUser(@RequestParam Integer numOfQuestions, @RequestParam String subject){
		List<Question> allQuestions=questionService.getQuestionsFromUser(numOfQuestions, subject);
